...
{
    res.sendFile('C:/Users/ahaqu/OneDrive/Desktop/DB PROJECT/home.html');
});
...
app.get('/login', function(req, res) {
    ...
    connection.query(query, function(err, result) {
      ...
      if (result && result.length > 0) {
        ...
        return res.sendFile("C:/Users/ahaqu/OneDrive/Desktop/DB PROJECT/errorPage.html");
      }
    })
});  
...
{
    res.sendFile("C:/Users/ahaqu/OneDrive/Desktop/DB PROJECT/signup.html")
})

app.get("/oldUser", function(req, response)
{
    response.sendFile("C:/Users/ahaqu/OneDrive/Desktop/DB PROJECT/login.html")
});
...
app.get('/signup', function(req, res){
    ...
    connection.query(query, function(err, results){
        ...
        return res.sendFile('C:/Users/ahaqu/OneDrive/Desktop/DB PROJECT/login.html');
    });
});
